...
export const mockQuotes: AdminQuote[] = [
  ...
  { id: 'q-006', reference: 'NETS-20260718-006006', customerId: 'cust-002', customerName: 'Engr. Bola Afolabi', customerEmail: 'b.afolabi@dangotelng.com', vehicleId: 'coaster', vehicleName: 'Toyota Coaster', pickup: 'Dangote Refinery, Ibeju-Lekki', destination: 'AIICO Building, VI', distanceKm: 50, durationMins: 90, tripType: 'Corporate Shuttle', passengerCount: 28, travelDate: daysFromNow(2), estimatedInvestment: 199020, status: 'approved', createdAt: daysAgo(6), notes: 'Daily recurring contract.' },
...
export const mockBookings: AdminBooking[] = [
  ...
  { id: 'bk-005', reference: 'BK-20260719-005', quoteReference: null, customerId: 'cust-006', customerName: 'Ms. Fatima Aliyu', vehicleId: 'coaster', vehicleName: 'Toyota Coaster', driverId: 'drv-004', driverName: 'Babatunde Fashola', pickup: 'Access Bank HQ, VI', destination: 'Transcorp Hilton, Abuja', distanceKm: 900, durationMins: 480, tripType: 'Multi-Day', passengerCount: 26, travelDate: daysFromNow(10), totalAmount: 403620, paymentStatus: 'paid', operationalStatus: 'confirmed', createdAt: daysAgo(5), notes: 'Full payment received.' },
